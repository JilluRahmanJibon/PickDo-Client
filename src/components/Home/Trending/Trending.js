...
function Trending() {
  ...
  return (
    <div className="mb-[20px] tablet:w-[1300px] w-[94%] mx-auto flex">
      <div className="tablet:w-[99%] w-[100%] tablet4:h-[500px] h-[] flex items-center rounded-[5px] bg-[#FEF1EF] mx-auto shadow-[0_0_2px_0_#00000040] py-[20px]">
        <div className="w-full tablet5:px-[20px] px-[10px]">
          ...
          <div className="flex justify-between items-center pb-[20px] px-[10px]">
            <div className="text-[black]">
              ...
              <h2 className="tablet4:text-[20px] text-[17px]">
